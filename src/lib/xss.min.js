...
})(
  {
    ...
    3: [
      function(require, module, exports) {
        ...
        const REGEXP_ATTR_NAME = /[^a-zA-Z0-9_:\.\-]/gim;
    ...
    5: [
      function(require, module, exports) {
        ...
        const DEFAULT = require('./default');
        const parser = require('./parser');
        const parseTag = parser.parseTag;
        const parseAttr = parser.parseAttr;
        const _ = require('./util');
        function isNull(obj) {
        ...
        FilterXSS.prototype.process = function(html) {
          ...
          let retHtml = parseTag(
            ...
            function(sourcePosition, position, tag, html, isClosing) {
              const info = { sourcePosition: sourcePosition, position: position, isClosing: isClosing, isWhite: tag in whiteList };
      ...
      function(require, module, exports) {
        ...
        FilterCSS.prototype.process = function(css) {
          ...
          const retCSS = parseStyle(css, function(sourcePosition, position, name, value, source) {
            ...
            const opts = { position: position, sourcePosition: sourcePosition, source: source, isWhite: isWhite };
            if (isWhite) {
    ...
    8: [
      function(require, module, exports) {
        ...
        for (const i in DEFAULT) exports[i] = DEFAULT[i];
        if (typeof window !== 'undefined') {
