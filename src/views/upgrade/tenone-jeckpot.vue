<template>
  <el-card class="box-card">
    ...
    >
      <tenone-jackpot-update :expressData="expressData" @ok="onChangeExpressOk" @cancel="onChangeExpressCancel" />
    </el-dialog>
    <!--奖池最低线设置对话框-->
    <el-dialog
      ...
      :close-on-click-modal="false"
    >
      <tenone-jackpot-update :expressData="expressData" @ok="onChangeExpressOkL" @cancel="onChangeExpressCancelL" />
    </el-dialog>
    <!--奖池最高线设置对话框-->
    <el-dialog
      ...
      :close-on-click-modal="false"
    >
      <tenone-jackpot-update :expressData="expressData" @ok="onChangeExpressOkH" @cancel="onChangeExpressCancelH" />
    </el-dialog>
    <!--送分池设置对话框-->
    <el-dialog
      ...
      :close-on-click-modal="false"
    >
      <tenone-jackpot-update :expressData="expressData" @ok="onChangeExpressOkS" @cancel="onChangeExpressCancelS" />
    </el-dialog>
    <!--最高预警线设置对话框-->
    <el-dialog
      ...
      :close-on-click-modal="false"
    >
      <tenone-jackpot-update :expressData="expressData" @ok="onChangeExpressOkHe" @cancel="onChangeExpressCancelHe" />
    </el-dialog>
    <!--抽水率设置对话框-->
    <el-dialog
      ...
      :close-on-click-modal="false"
    >
      <tenone-jackpot-update :expressData="expressData" @ok="onChangeExpressOkP" @cancel="onChangeExpressCancelP" />
    </el-dialog>
...
import tenoneJackpotUpdate from './tenone-jackpot-update';
import tenoneFormulaAdd from './tenone-formula-add';
...
export default {
  ...
  methods: {
    ...
    getJackpotValue() {
      const getjackpot = { gameId: 1 };
      getjackpotList(getjackpot)
        .then(response => {
